...
@Component({
  selector: 'app-ordenar-producto-fijos',
  templateUrl: './ordenar-producto-fijos.component.html',
  styleUrls: ['./ordenar-producto-fijos.component.scss']
})
export class OrdenarProductoFijosComponent implements OnInit {
